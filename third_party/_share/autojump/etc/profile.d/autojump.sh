...
if [ -s /home/martino/.shell_config/third_party/_share/autojump/share/autojump/autojump.${shell} ]; then         
    source /home/martino/.shell_config/third_party/_share/autojump/share/autojump/autojump.${shell}         
fi
